...
public class RestaurantApprovalOutboxScheduler implements OutboxScheduler {
    ...
    public RestaurantApprovalOutboxScheduler(RestaurantApprovalOutboxHelper restaurantApprovalOutboxHelper,
    ...
    public void processOutboxMessage() {
        ...
        if (approvalOutboxMessages.isPresent() && approvalOutboxMessages.get().size() > 0) {
